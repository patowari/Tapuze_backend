...
3.  "explanation": A clear, constructive bilingual explanation of the mistake.
4.  "boundingBox": An object with normalized coordinates ("x", "y", "width", "height") for the error's location on the image.
